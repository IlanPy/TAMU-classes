...
int testShortestPathConnectedGraph() {
    ...
    std::cout << expectedPath1 << " || " <<  path1 << endl;
    ...
    std::cout << expectedPath2 << " || " <<  path2 << endl;
    ...
    std::cout << expectedPath3 << " || " <<  path3 << endl;
    ...
    std::cout << expectedPath4 << " || " <<  path4 << endl;
    ...
    std::cout << expectedPath5 << " || " <<  path5 << endl;
    ...
    std::cout << expectedPath8 << " || " <<  path8 << endl;
